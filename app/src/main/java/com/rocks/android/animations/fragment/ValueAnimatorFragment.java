...
import com.rocks.android.animations.AppConfig;
...
System.out.println("AppConfig.getDeviceHeght(getActivity()) "+AppConfig.getDeviceHeght(getActivity()));
        ValueAnimator animator=ValueAnimator.ofInt(0, AppConfig.getDeviceHeght(getActivity()));
